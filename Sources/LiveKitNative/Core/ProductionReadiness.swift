...
public extension LiveKitNative {
    static let productionReadiness = LiveKitNativeProductionReadiness(
        ...
        blockers: [
            ...
            "A default subscriber RTP receive pipeline now integrates jitter buffering with bounded NACK/PLI feedback, but general production video meetings still require full packet-loss recovery, RTCP reports, bandwidth estimation, congestion control, adaptive quality, and bounded backpressure/frame-drop policy.",
