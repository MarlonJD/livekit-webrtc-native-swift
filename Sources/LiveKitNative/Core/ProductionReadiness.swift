...
public extension LiveKitNative {
    static let productionReadiness = LiveKitNativeProductionReadiness(
        ...
        blockers: [
            ...
            "SCTP data channel support includes packet-level DCEP/DataPacket planning and queued local publish flushing through an injectable packet transport, but it is not connected to a live DTLS-backed SCTP association.",
