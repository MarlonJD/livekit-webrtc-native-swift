...
public enum Livekit_AudioCodec: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Livekit_AudioCodec] = [
    .defaultAc,
    .opus,
    .aac,
    .acMp3,
...
public enum Livekit_VideoCodec: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case defaultVc // = 0
  case h264Baseline // = 1
  case h264Main // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_VideoCodec] = [
    .defaultVc,
    .h264Baseline,
    .h264Main,
    .h264High,
...
public enum Livekit_ImageCodec: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case icDefault // = 0
  case icJpeg // = 1
  case UNRECOGNIZED(Int)
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_ImageCodec] = [
    .icDefault,
    .icJpeg,
  ]
...
public enum Livekit_BackupCodecPolicy: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_BackupCodecPolicy] = [
    .preferRegression,
    .simulcast,
    .regression,
  ]
...
public enum Livekit_TrackType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case audio // = 0
  case video // = 1
  case data // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_TrackType] = [
    .audio,
    .video,
    .data,
  ]
...
public enum Livekit_TrackSource: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
  case camera // = 1
  case microphone // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_TrackSource] = [
    .unknown,
    .camera,
    .microphone,
    .screenShare,
...
public enum Livekit_DataTrackExtensionID: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case dteiInvalid // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_DataTrackExtensionID] = [
    .dteiInvalid,
    .dteiParticipantSid,
  ]
...
public enum Livekit_VideoQuality: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case low // = 0
  case medium // = 1
  case high // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_VideoQuality] = [
    .low,
    .medium,
    .high,
    .off,
...
public enum Livekit_ConnectionQuality: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case poor // = 0
  case good // = 1
  case excellent // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_ConnectionQuality] = [
    .poor,
    .good,
    .excellent,
    .lost,
...
public enum Livekit_ClientConfigSetting: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unset // = 0
  case disabled // = 1
  case enabled // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_ClientConfigSetting] = [
    .unset,
    .disabled,
    .enabled,
  ]
...
public enum Livekit_DisconnectReason: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_DisconnectReason] = [
    .unknownReason,
    .clientInitiated,
    .duplicateIdentity,
    .serverShutdown,
...
public enum Livekit_ReconnectReason: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case rrUnknown // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_ReconnectReason] = [
    .rrUnknown,
...
public enum Livekit_SubscriptionError: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case seUnknown // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_SubscriptionError] = [
    .seUnknown,
    .seCodecUnsupported,
    .seTrackNotfound,
  ]
...
public enum Livekit_AudioTrackFeature: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case tfStereo // = 0
  case tfNoDtx // = 1
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Livekit_AudioTrackFeature] = [
    .tfStereo,
    .tfNoDtx,
    .tfAutoGainControl,
    .tfEchoCancellation,
...
public struct Livekit_Pagination: Sendable {
...
public struct Livekit_TokenPagination: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_ListUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_Room: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var emptyTimeout: UInt32 = 0

  public var departureTimeout: UInt32 = 0

  public var maxParticipants: UInt32 = 0

  public var creationTime: Int64 = 0

  public var creationTimeMs: Int64 = 0

  public var turnPassword: String = String()

  public var enabledCodecs: [Livekit_Codec] = []

  public var metadata: String = String()

  public var numParticipants: UInt32 = 0

  public var numPublishers: UInt32 = 0

  public var activeRecording: Bool = false

  public var version: Livekit_TimedVersion {
...
public struct Livekit_Codec: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var fmtpLine: String = String()
...
public struct Livekit_PlayoutDelay: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_ParticipantPermission: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// allow participant to subscribe to other tracks in the room
  public var canSubscribe: Bool = false
  ...
  public var canPublishSources: [Livekit_TrackSource] = []
  ...
  public var recorder: Bool = false

  /// indicates that participant can update own metadata and attributes
  public var canUpdateMetadata: Bool = false

  /// indicates that participant is an agent
  /// deprecated: use ParticipantInfo.kind instead
  ///
  /// NOTE: This field was marked as deprecated in the .proto file.
  public var agent: Bool = false

  /// if a participant can subscribe to metrics
  public var canSubscribeMetrics: Bool = false
...
public struct Livekit_ParticipantInfo: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var state: Livekit_ParticipantInfo.State {
    get {_storage._state}
    set {_uniqueStorage()._state = newValue}
  }

  public var tracks: [Livekit_TrackInfo] {
  ...
  public var permission: Livekit_ParticipantPermission {
  ...
  public var hasPermission: Bool {_storage._permission != nil}
  /// Clears the value of `permission`. Subsequent reads from it will return its default value.
  public mutating func clearPermission() {_uniqueStorage()._permission = nil}
  ...
  public var kind: Livekit_ParticipantInfo.Kind {
    get {_storage._kind}
  ...
  public var disconnectReason: Livekit_DisconnectReason {
    get {_storage._disconnectReason}
    set {_uniqueStorage()._disconnectReason = newValue}
  }

  public var kindDetails: [Livekit_ParticipantInfo.KindDetail] {
    get {_storage._kindDetails}
    set {_uniqueStorage()._kindDetails = newValue}
  }

  public var dataTracks: [Livekit_DataTrackInfo] {
  ...
  public enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_ParticipantInfo.State] = [
      .joining,
      .joined,
      .active,
      .disconnected,
  ...
  public enum Kind: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_ParticipantInfo.Kind] = [
      .standard,
      .ingress,
      .egress,
      .sip,
  ...
  public enum KindDetail: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    case cloudAgent // = 0
    case forwarded // = 1
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_ParticipantInfo.KindDetail] = [
      .cloudAgent,
      .forwarded,
      .connectorWhatsapp,
      .connectorTwilio,
...
public struct Livekit_Encryption: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum TypeEnum: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_Encryption.TypeEnum] = [
      .none,
      .gcm,
      .custom,
    ]
...
public struct Livekit_SimulcastCodecInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var layers: [Livekit_VideoLayer] = []

  public var videoLayerMode: Livekit_VideoLayer.Mode = .unused
  ...
  public var sdpCid: String = String()
...
public struct Livekit_TrackInfo: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Livekit_TrackType {
    get {_storage._type}
  ...
  ///
  /// NOTE: This field was marked as deprecated in the .proto file.
  public var disableDtx: Bool {
    get {_storage._disableDtx}
    set {_uniqueStorage()._disableDtx = newValue}
  }

  /// source of media
  public var source: Livekit_TrackSource {
  ...
  public var codecs: [Livekit_SimulcastCodecInfo] {
  ...
  public var disableRed: Bool {
    get {_storage._disableRed}
    set {_uniqueStorage()._disableRed = newValue}
  }

  public var encryption: Livekit_Encryption.TypeEnum {
  ...
  public var audioFeatures: [Livekit_AudioTrackFeature] {
    get {_storage._audioFeatures}
    set {_uniqueStorage()._audioFeatures = newValue}
  }

  public var backupCodecPolicy: Livekit_BackupCodecPolicy {
...
public struct Livekit_DataTrackInfo: Sendable {
  ...
  public var encryption: Livekit_Encryption.TypeEnum = .none
...
public struct Livekit_DataTrackExtensionParticipantSid: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var id: Livekit_DataTrackExtensionID = .dteiInvalid

  public var participantSid: String = String()
...
public struct Livekit_DataTrackSubscriptionOptions: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasTargetFps: Bool {self._targetFps != nil}
  /// Clears the value of `targetFps`. Subsequent reads from it will return its default value.
  public mutating func clearTargetFps() {self._targetFps = nil}
...
public struct Livekit_VideoLayer: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// for tracks with a single layer, this should be HIGH
  public var quality: Livekit_VideoQuality = .low
  ...
  public var spatialLayer: Int32 = 0

  public var rid: String = String()

  public var repairSsrc: UInt32 = 0
  ...
  public enum Mode: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_VideoLayer.Mode] = [
      .unused,
...
/// new DataPacket API
public struct Livekit_DataPacket: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// NOTE: This field was marked as deprecated in the .proto file.
  public var kind: Livekit_DataPacket.Kind {
    get {_storage._kind}
    set {_uniqueStorage()._kind = newValue}
  }
  ...
  public var user: Livekit_UserPacket {
    get {
  ...
  /// NOTE: This field was marked as deprecated in the .proto file.
  public var speaker: Livekit_ActiveSpeakerUpdate {
    get {
  ...
  public var sipDtmf: Livekit_SipDTMF {
    get {
  ...
  public var transcription: Livekit_Transcription {
    get {
  ...
  public var metrics: Livekit_MetricsBatch {
    get {
  ...
  public var chatMessage: Livekit_ChatMessage {
    get {
  ...
  public var rpcRequest: Livekit_RpcRequest {
    get {
  ...
  public var rpcAck: Livekit_RpcAck {
    get {
  ...
  public var rpcResponse: Livekit_RpcResponse {
    get {
  ...
  public var streamHeader: Livekit_DataStream.Header {
    get {
  ...
  public var streamChunk: Livekit_DataStream.Chunk {
    get {
  ...
  public var streamTrailer: Livekit_DataStream.Trailer {
    get {
  ...
  public var encryptedPacket: Livekit_EncryptedPacket {
    get {
  ...
  public enum Kind: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_DataPacket.Kind] = [
      .reliable,
      .lossy,
    ]
...
public struct Livekit_EncryptedPacket: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var encryptionType: Livekit_Encryption.TypeEnum = .none

  public var iv: Data = Data()

  public var keyIndex: UInt32 = 0

  /// This is an encrypted EncryptedPacketPayload message representation
  public var encryptedValue: Data = Data()
...
public struct Livekit_EncryptedPacketPayload: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var value: Livekit_EncryptedPacketPayload.OneOf_Value? = nil
...
public struct Livekit_ActiveSpeakerUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var speakers: [Livekit_SpeakerInfo] = []
...
public struct Livekit_SpeakerInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_UserPacket: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_SipDTMF: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var digit: String = String()
...
public struct Livekit_Transcription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Participant that got its speech transcribed
  public var transcribedParticipantIdentity: String = String()

  public var trackID: String = String()

  public var segments: [Livekit_TranscriptionSegment] = []
...
public struct Livekit_TranscriptionSegment: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_ChatMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_RpcRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var responseTimeoutMs: UInt32 = 0
...
public struct Livekit_RpcAck: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_RpcResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var value: Livekit_RpcResponse.OneOf_Value? = nil
  ...
  public var error: Livekit_RpcError {
    get {
...
public struct Livekit_RpcError: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_ParticipantTracks: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_ServerInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var edition: Livekit_ServerInfo.Edition = .standard
  ...
  public var agentProtocol: Int32 = 0

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum Edition: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    case standard // = 0
    case cloud // = 1
    case UNRECOGNIZED(Int)
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_ServerInfo.Edition] = [
      .standard,
      .cloud,
    ]
...
public struct Livekit_ClientInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var sdk: Livekit_ClientInfo.SDK = .unknown
  ...
  public var browserVersion: String = String()
  ...
  public var otherSdks: String = String()

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum SDK: SwiftProtobuf.Enum, Swift.CaseIterable {
    public typealias RawValue = Int
    case unknown // = 0
    case js // = 1
    case swift // = 2
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_ClientInfo.SDK] = [
      .unknown,
      .js,
      .swift,
      .android,
...
public struct Livekit_ClientConfiguration: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var video: Livekit_VideoConfiguration {
  ...
  public var screen: Livekit_VideoConfiguration {
  ...
  public var resumeConnection: Livekit_ClientConfigSetting = .unset

  public var disabledCodecs: Livekit_DisabledCodecs {
  ...
  public var hasDisabledCodecs: Bool {self._disabledCodecs != nil}
  /// Clears the value of `disabledCodecs`. Subsequent reads from it will return its default value.
  public mutating func clearDisabledCodecs() {self._disabledCodecs = nil}

  public var forceRelay: Livekit_ClientConfigSetting = .unset
...
public struct Livekit_VideoConfiguration: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var hardwareEncoder: Livekit_ClientConfigSetting = .unset
...
public struct Livekit_DisabledCodecs: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// disabled for both publish and subscribe
  public var codecs: [Livekit_Codec] = []

  /// only disable for publish
  public var publish: [Livekit_Codec] = []
...
public struct Livekit_RTPDrift: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rtpClockTicks: UInt64 = 0

  public var driftSamples: Int64 = 0

  public var driftMs: Double = 0

  public var clockRate: Double = 0
...
public struct Livekit_RTPStats: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var hasLastPli: Bool {_storage._lastPli != nil}
  /// Clears the value of `lastPli`. Subsequent reads from it will return its default value.
  public mutating func clearLastPli() {_uniqueStorage()._lastPli = nil}

  public var firs: UInt32 {
    get {_storage._firs}
    set {_uniqueStorage()._firs = newValue}
  }

  public var lastFir: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasLastFir: Bool {_storage._lastFir != nil}
  /// Clears the value of `lastFir`. Subsequent reads from it will return its default value.
  public mutating func clearLastFir() {_uniqueStorage()._lastFir = nil}

  public var rttCurrent: UInt32 {
    get {_storage._rttCurrent}
    set {_uniqueStorage()._rttCurrent = newValue}
  }

  public var rttMax: UInt32 {
  ...
  public var lastKeyFrame: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasLastKeyFrame: Bool {_storage._lastKeyFrame != nil}
  /// Clears the value of `lastKeyFrame`. Subsequent reads from it will return its default value.
  public mutating func clearLastKeyFrame() {_uniqueStorage()._lastKeyFrame = nil}

  public var layerLockPlis: UInt32 {
    get {_storage._layerLockPlis}
    set {_uniqueStorage()._layerLockPlis = newValue}
  }

  public var lastLayerLockPli: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasLastLayerLockPli: Bool {_storage._lastLayerLockPli != nil}
  /// Clears the value of `lastLayerLockPli`. Subsequent reads from it will return its default value.
  public mutating func clearLastLayerLockPli() {_uniqueStorage()._lastLayerLockPli = nil}

  public var packetDrift: Livekit_RTPDrift {
  ...
  public var hasPacketDrift: Bool {_storage._packetDrift != nil}
  /// Clears the value of `packetDrift`. Subsequent reads from it will return its default value.
  public mutating func clearPacketDrift() {_uniqueStorage()._packetDrift = nil}

  public var ntpReportDrift: Livekit_RTPDrift {
  ...
  public var hasNtpReportDrift: Bool {_storage._ntpReportDrift != nil}
  /// Clears the value of `ntpReportDrift`. Subsequent reads from it will return its default value.
  public mutating func clearNtpReportDrift() {_uniqueStorage()._ntpReportDrift = nil}

  public var rebasedReportDrift: Livekit_RTPDrift {
  ...
  public var hasRebasedReportDrift: Bool {_storage._rebasedReportDrift != nil}
  /// Clears the value of `rebasedReportDrift`. Subsequent reads from it will return its default value.
  public mutating func clearRebasedReportDrift() {_uniqueStorage()._rebasedReportDrift = nil}

  /// NEXT_ID: 48
  public var receivedReportDrift: Livekit_RTPDrift {
  ...
  public var hasReceivedReportDrift: Bool {_storage._receivedReportDrift != nil}
  /// Clears the value of `receivedReportDrift`. Subsequent reads from it will return its default value.
  public mutating func clearReceivedReportDrift() {_uniqueStorage()._receivedReportDrift = nil}
...
public struct Livekit_RTCPSenderReportState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rtpTimestampExt: UInt64 = 0
...
public struct Livekit_RTPForwarderState: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var referenceLayerSpatial: Int32 {
  ...
  public var hasRtpMunger: Bool {_storage._rtpMunger != nil}
  /// Clears the value of `rtpMunger`. Subsequent reads from it will return its default value.
  public mutating func clearRtpMunger() {_uniqueStorage()._rtpMunger = nil}

  public var codecMunger: OneOf_CodecMunger? {
    get {return _storage._codecMunger}
    set {_uniqueStorage()._codecMunger = newValue}
  }

  public var vp8Munger: Livekit_VP8MungerState {
    get {
  ...
  public var senderReportState: [Livekit_RTCPSenderReportState] {
  ...
  public enum OneOf_CodecMunger: Equatable, Sendable {
...
public struct Livekit_RTPMungerState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var extLastSequenceNumber: UInt64 = 0

  public var extSecondLastSequenceNumber: UInt64 = 0

  public var extLastTimestamp: UInt64 = 0

  public var extSecondLastTimestamp: UInt64 = 0

  public var lastMarker: Bool = false

  public var secondLastMarker: Bool = false
...
public struct Livekit_VP8MungerState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var extLastPictureID: Int32 = 0

  public var pictureIDUsed: Bool = false

  public var lastTl0PicIdx: UInt32 = 0

  public var tl0PicIdxUsed: Bool = false

  public var tidUsed: Bool = false

  public var lastKeyIdx: UInt32 = 0

  public var keyIdxUsed: Bool = false
...
public struct Livekit_TimedVersion: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var unixMicro: Int64 = 0
...
public struct Livekit_DataStream: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OperationType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Livekit_DataStream.OperationType] = [
      .create,
      .update,
      .delete,
      .reaction,
  ...
  public struct TextHeader: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var operationType: Livekit_DataStream.OperationType = .create

    /// Optional: Version for updates/edits
    public var version: Int32 = 0

    /// Optional: Reply to specific message
    public var replyToStreamID: String = String()
  ...
  public struct ByteHeader: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct Header: Sendable {
    ...
    public var contentHeader: Livekit_DataStream.Header.OneOf_ContentHeader? = nil

    public var textHeader: Livekit_DataStream.TextHeader {
      get {
    ...
    public var byteHeader: Livekit_DataStream.ByteHeader {
      get {
    ...
    /// oneof to choose between specific header types
    public enum OneOf_ContentHeader: Equatable, Sendable {
...
public struct Livekit_FilterParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var includeEvents: [String] = []

  public var excludeEvents: [String] = []
...
public struct Livekit_WebhookConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_SubscribedAudioCodec: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Livekit_AudioCodec: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DEFAULT_AC\0\u{1}OPUS\0\u{1}AAC\0\u{1}AC_MP3\0")
}

extension Livekit_VideoCodec: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DEFAULT_VC\0\u{1}H264_BASELINE\0\u{1}H264_MAIN\0\u{1}H264_HIGH\0\u{1}VP8\0")
}

extension Livekit_ImageCodec: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0IC_DEFAULT\0\u{1}IC_JPEG\0")
}

extension Livekit_BackupCodecPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0PREFER_REGRESSION\0\u{1}SIMULCAST\0\u{1}REGRESSION\0")
}

extension Livekit_TrackType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0AUDIO\0\u{1}VIDEO\0\u{1}DATA\0")
}

extension Livekit_TrackSource: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}CAMERA\0\u{1}MICROPHONE\0\u{1}SCREEN_SHARE\0\u{1}SCREEN_SHARE_AUDIO\0")
}

extension Livekit_DataTrackExtensionID: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DTEI_INVALID\0\u{1}DTEI_PARTICIPANT_SID\0")
}

extension Livekit_VideoQuality: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0LOW\0\u{1}MEDIUM\0\u{1}HIGH\0\u{1}OFF\0")
}

extension Livekit_ConnectionQuality: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0POOR\0\u{1}GOOD\0\u{1}EXCELLENT\0\u{1}LOST\0")
}

extension Livekit_ClientConfigSetting: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNSET\0\u{1}DISABLED\0\u{1}ENABLED\0")
}
...
extension Livekit_ReconnectReason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RR_UNKNOWN\0\u{1}RR_SIGNAL_DISCONNECTED\0\u{1}RR_PUBLISHER_FAILED\0\u{1}RR_SUBSCRIBER_FAILED\0\u{1}RR_SWITCH_CANDIDATE\0")
}

extension Livekit_SubscriptionError: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SE_UNKNOWN\0\u{1}SE_CODEC_UNSUPPORTED\0\u{1}SE_TRACK_NOTFOUND\0")
}

extension Livekit_AudioTrackFeature: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TF_STEREO\0\u{1}TF_NO_DTX\0\u{1}TF_AUTO_GAIN_CONTROL\0\u{1}TF_ECHO_CANCELLATION\0\u{1}TF_NOISE_SUPPRESSION\0\u{1}TF_ENHANCED_NOISE_CANCELLATION\0\u{1}TF_PRECONNECT_BUFFER\0")
}
...
extension Livekit_Pagination: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}after_id\0\u{1}limit\0")
  ...
  public static func ==(lhs: Livekit_Pagination, rhs: Livekit_Pagination) -> Bool {
...
extension Livekit_TokenPagination: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TokenPagination"
  ...
  public static func ==(lhs: Livekit_TokenPagination, rhs: Livekit_TokenPagination) -> Bool {
...
extension Livekit_ListUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ListUpdate"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}set\0\u{1}add\0\u{1}remove\0\u{1}clear\0")
  ...
  public static func ==(lhs: Livekit_ListUpdate, rhs: Livekit_ListUpdate) -> Bool {
...
extension Livekit_Room: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Livekit_Room, rhs: Livekit_Room) -> Bool {
...
extension Livekit_Codec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Codec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}mime\0\u{3}fmtp_line\0")
  ...
  public static func ==(lhs: Livekit_Codec, rhs: Livekit_Codec) -> Bool {
...
extension Livekit_PlayoutDelay: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PlayoutDelay"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}enabled\0\u{1}min\0\u{1}max\0")
  ...
  public static func ==(lhs: Livekit_PlayoutDelay, rhs: Livekit_PlayoutDelay) -> Bool {
...
extension Livekit_ParticipantPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ParticipantPermission"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}can_subscribe\0\u{3}can_publish\0\u{3}can_publish_data\0\u{2}\u{4}hidden\0\u{1}recorder\0\u{3}can_publish_sources\0\u{3}can_update_metadata\0\u{1}agent\0\u{3}can_subscribe_metrics\0")
  ...
  public static func ==(lhs: Livekit_ParticipantPermission, rhs: Livekit_ParticipantPermission) -> Bool {
...
extension Livekit_ParticipantInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ParticipantInfo"
  ...
  public static func ==(lhs: Livekit_ParticipantInfo, rhs: Livekit_ParticipantInfo) -> Bool {
...
extension Livekit_ParticipantInfo.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0JOINING\0\u{1}JOINED\0\u{1}ACTIVE\0\u{1}DISCONNECTED\0")
}

extension Livekit_ParticipantInfo.Kind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STANDARD\0\u{1}INGRESS\0\u{1}EGRESS\0\u{1}SIP\0\u{1}AGENT\0\u{2}\u{3}CONNECTOR\0\u{1}BRIDGE\0")
}

extension Livekit_ParticipantInfo.KindDetail: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CLOUD_AGENT\0\u{1}FORWARDED\0\u{1}CONNECTOR_WHATSAPP\0\u{1}CONNECTOR_TWILIO\0\u{1}BRIDGE_RTSP\0")
}
...
extension Livekit_Encryption: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Livekit_Encryption, rhs: Livekit_Encryption) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Livekit_Encryption.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NONE\0\u{1}GCM\0\u{1}CUSTOM\0")
}
...
extension Livekit_SimulcastCodecInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SimulcastCodecInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}mime_type\0\u{1}mid\0\u{1}cid\0\u{1}layers\0\u{3}video_layer_mode\0\u{3}sdp_cid\0")
  ...
  public static func ==(lhs: Livekit_SimulcastCodecInfo, rhs: Livekit_SimulcastCodecInfo) -> Bool {
...
extension Livekit_TrackInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TrackInfo"
  ...
  public static func ==(lhs: Livekit_TrackInfo, rhs: Livekit_TrackInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Livekit_DataTrackInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DataTrackInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}pub_handle\0\u{1}sid\0\u{1}name\0\u{1}encryption\0")
  ...
  public static func ==(lhs: Livekit_DataTrackInfo, rhs: Livekit_DataTrackInfo) -> Bool {
...
extension Livekit_DataTrackExtensionParticipantSid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DataTrackExtensionParticipantSid"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}participant_sid\0")
  ...
  public static func ==(lhs: Livekit_DataTrackExtensionParticipantSid, rhs: Livekit_DataTrackExtensionParticipantSid) -> Bool {
...
extension Livekit_DataTrackSubscriptionOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DataTrackSubscriptionOptions"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}target_fps\0")
  ...
  public static func ==(lhs: Livekit_DataTrackSubscriptionOptions, rhs: Livekit_DataTrackSubscriptionOptions) -> Bool {
...
extension Livekit_VideoLayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VideoLayer"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}quality\0\u{1}width\0\u{1}height\0\u{1}bitrate\0\u{1}ssrc\0\u{3}spatial_layer\0\u{1}rid\0\u{3}repair_ssrc\0")
  ...
  public static func ==(lhs: Livekit_VideoLayer, rhs: Livekit_VideoLayer) -> Bool {
...
extension Livekit_VideoLayer.Mode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0MODE_UNUSED\0\u{1}ONE_SPATIAL_LAYER_PER_STREAM\0\u{1}MULTIPLE_SPATIAL_LAYERS_PER_STREAM\0\u{1}ONE_SPATIAL_LAYER_PER_STREAM_INCOMPLETE_RTCP_SR\0")
}
...
extension Livekit_DataPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DataPacket"
  ...
  public static func ==(lhs: Livekit_DataPacket, rhs: Livekit_DataPacket) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Livekit_DataPacket.Kind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0RELIABLE\0\u{1}LOSSY\0")
}
...
extension Livekit_EncryptedPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".EncryptedPacket"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}encryption_type\0\u{1}iv\0\u{3}key_index\0\u{3}encrypted_value\0")
  ...
  public static func ==(lhs: Livekit_EncryptedPacket, rhs: Livekit_EncryptedPacket) -> Bool {
...
extension Livekit_EncryptedPacketPayload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".EncryptedPacketPayload"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}user\0\u{4}\u{2}chat_message\0\u{3}rpc_request\0\u{3}rpc_ack\0\u{3}rpc_response\0\u{3}stream_header\0\u{3}stream_chunk\0\u{3}stream_trailer\0")
  ...
  public static func ==(lhs: Livekit_EncryptedPacketPayload, rhs: Livekit_EncryptedPacketPayload) -> Bool {
...
extension Livekit_ActiveSpeakerUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ActiveSpeakerUpdate"
  ...
  public static func ==(lhs: Livekit_ActiveSpeakerUpdate, rhs: Livekit_ActiveSpeakerUpdate) -> Bool {
...
extension Livekit_SpeakerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}sid\0\u{1}level\0\u{1}active\0")
  ...
  public static func ==(lhs: Livekit_SpeakerInfo, rhs: Livekit_SpeakerInfo) -> Bool {
    if lhs.sid != rhs.sid {return false}
...
extension Livekit_UserPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UserPacket"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}participant_sid\0\u{1}payload\0\u{3}destination_sids\0\u{1}topic\0\u{3}participant_identity\0\u{3}destination_identities\0\u{2}\u{2}id\0\u{3}start_time\0\u{3}end_time\0\u{1}nonce\0")
  ...
  public static func ==(lhs: Livekit_UserPacket, rhs: Livekit_UserPacket) -> Bool {
    if lhs.participantSid != rhs.participantSid {return false}
...
extension Livekit_SipDTMF: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SipDTMF"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{3}code\0\u{1}digit\0")
  ...
  public static func ==(lhs: Livekit_SipDTMF, rhs: Livekit_SipDTMF) -> Bool {
...
extension Livekit_Transcription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Transcription"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}transcribed_participant_identity\0\u{3}track_id\0\u{1}segments\0")
  ...
  public static func ==(lhs: Livekit_Transcription, rhs: Livekit_Transcription) -> Bool {
...
extension Livekit_TranscriptionSegment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}text\0\u{3}start_time\0\u{3}end_time\0\u{1}final\0\u{1}language\0")
  ...
  public static func ==(lhs: Livekit_TranscriptionSegment, rhs: Livekit_TranscriptionSegment) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Livekit_ChatMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}timestamp\0\u{3}edit_timestamp\0\u{1}message\0\u{1}deleted\0\u{1}generated\0")
  ...
  public static func ==(lhs: Livekit_ChatMessage, rhs: Livekit_ChatMessage) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Livekit_RpcRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}method\0\u{1}payload\0\u{3}response_timeout_ms\0\u{1}version\0")
  ...
  public static func ==(lhs: Livekit_RpcRequest, rhs: Livekit_RpcRequest) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Livekit_RpcAck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RpcAck"
  ...
  public static func ==(lhs: Livekit_RpcAck, rhs: Livekit_RpcAck) -> Bool {
...
extension Livekit_RpcResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_id\0\u{1}payload\0\u{1}error\0")
  ...
  public static func ==(lhs: Livekit_RpcResponse, rhs: Livekit_RpcResponse) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
    if lhs.value != rhs.value {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Livekit_RpcError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Livekit_RpcError, rhs: Livekit_RpcError) -> Bool {
    if lhs.code != rhs.code {return false}
    if lhs.message != rhs.message {return false}
...
extension Livekit_ParticipantTracks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ParticipantTracks"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}participant_sid\0\u{3}track_sids\0")
  ...
  public static func ==(lhs: Livekit_ParticipantTracks, rhs: Livekit_ParticipantTracks) -> Bool {
    if lhs.participantSid != rhs.participantSid {return false}
...
extension Livekit_ServerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}edition\0\u{1}version\0\u{1}protocol\0\u{1}region\0\u{3}node_id\0\u{3}debug_info\0\u{3}agent_protocol\0")
  ...
  public static func ==(lhs: Livekit_ServerInfo, rhs: Livekit_ServerInfo) -> Bool {
...
extension Livekit_ServerInfo.Edition: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0Standard\0\u{1}Cloud\0")
}
...
extension Livekit_ClientInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}sdk\0\u{1}version\0\u{1}protocol\0\u{1}os\0\u{3}os_version\0\u{3}device_model\0\u{1}browser\0\u{3}browser_version\0\u{1}address\0\u{1}network\0\u{3}other_sdks\0")
  ...
  public static func ==(lhs: Livekit_ClientInfo, rhs: Livekit_ClientInfo) -> Bool {
...
extension Livekit_ClientInfo.SDK: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}JS\0\u{1}SWIFT\0\u{1}ANDROID\0\u{1}FLUTTER\0\u{1}GO\0\u{1}UNITY\0\u{1}REACT_NATIVE\0\u{1}RUST\0\u{1}PYTHON\0\u{1}CPP\0\u{1}UNITY_WEB\0\u{1}NODE\0\u{1}UNREAL\0\u{1}ESP32\0")
}
...
extension Livekit_ClientConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ClientConfiguration"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}video\0\u{1}screen\0\u{3}resume_connection\0\u{3}disabled_codecs\0\u{3}force_relay\0")
  ...
  public static func ==(lhs: Livekit_ClientConfiguration, rhs: Livekit_ClientConfiguration) -> Bool {
...
extension Livekit_VideoConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VideoConfiguration"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}hardware_encoder\0")
  ...
  public static func ==(lhs: Livekit_VideoConfiguration, rhs: Livekit_VideoConfiguration) -> Bool {
...
extension Livekit_DisabledCodecs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DisabledCodecs"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}codecs\0\u{1}publish\0")
  ...
  public static func ==(lhs: Livekit_DisabledCodecs, rhs: Livekit_DisabledCodecs) -> Bool {
...
extension Livekit_RTPDrift: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RTPDrift"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_time\0\u{3}end_time\0\u{1}duration\0\u{3}start_timestamp\0\u{3}end_timestamp\0\u{3}rtp_clock_ticks\0\u{3}drift_samples\0\u{3}drift_ms\0\u{3}clock_rate\0")
  ...
  public static func ==(lhs: Livekit_RTPDrift, rhs: Livekit_RTPDrift) -> Bool {
    if lhs._startTime != rhs._startTime {return false}
    if lhs._endTime != rhs._endTime {return false}
...
extension Livekit_RTPStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RTPStats"
  ...
  public static func ==(lhs: Livekit_RTPStats, rhs: Livekit_RTPStats) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Livekit_RTCPSenderReportState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RTCPSenderReportState"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}rtp_timestamp\0\u{3}rtp_timestamp_ext\0\u{3}ntp_timestamp\0\u{1}at\0\u{3}at_adjusted\0\u{1}packets\0\u{1}octets\0")
  ...
  public static func ==(lhs: Livekit_RTCPSenderReportState, rhs: Livekit_RTCPSenderReportState) -> Bool {
...
extension Livekit_RTPForwarderState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RTPForwarderState"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}started\0\u{3}reference_layer_spatial\0\u{3}pre_start_time\0\u{3}ext_first_timestamp\0\u{3}dummy_start_timestamp_offset\0\u{3}rtp_munger\0\u{3}vp8_munger\0\u{3}sender_report_state\0")
  ...
  public static func ==(lhs: Livekit_RTPForwarderState, rhs: Livekit_RTPForwarderState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Livekit_RTPMungerState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RTPMungerState"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ext_last_sequence_number\0\u{3}ext_second_last_sequence_number\0\u{3}ext_last_timestamp\0\u{3}ext_second_last_timestamp\0\u{3}last_marker\0\u{3}second_last_marker\0")
  ...
  public static func ==(lhs: Livekit_RTPMungerState, rhs: Livekit_RTPMungerState) -> Bool {
...
extension Livekit_VP8MungerState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VP8MungerState"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ext_last_picture_id\0\u{3}picture_id_used\0\u{3}last_tl0_pic_idx\0\u{3}tl0_pic_idx_used\0\u{3}tid_used\0\u{3}last_key_idx\0\u{3}key_idx_used\0")
  ...
  public static func ==(lhs: Livekit_VP8MungerState, rhs: Livekit_VP8MungerState) -> Bool {
...
extension Livekit_TimedVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimedVersion"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}unix_micro\0\u{1}ticks\0")
  ...
  public static func ==(lhs: Livekit_TimedVersion, rhs: Livekit_TimedVersion) -> Bool {
...
extension Livekit_DataStream: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DataStream"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Livekit_DataStream, rhs: Livekit_DataStream) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Livekit_DataStream.OperationType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0CREATE\0\u{1}UPDATE\0\u{1}DELETE\0\u{1}REACTION\0")
}
...
extension Livekit_DataStream.TextHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Livekit_DataStream.protoMessageName + ".TextHeader"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}operation_type\0\u{1}version\0\u{3}reply_to_stream_id\0\u{3}attached_stream_ids\0\u{1}generated\0")
  ...
  public static func ==(lhs: Livekit_DataStream.TextHeader, rhs: Livekit_DataStream.TextHeader) -> Bool {
...
extension Livekit_DataStream.ByteHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Livekit_DataStream.protoMessageName + ".ByteHeader"
  ...
  public static func ==(lhs: Livekit_DataStream.ByteHeader, rhs: Livekit_DataStream.ByteHeader) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Livekit_DataStream.Header: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Livekit_DataStream.protoMessageName + ".Header"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}stream_id\0\u{1}timestamp\0\u{1}topic\0\u{3}mime_type\0\u{3}total_length\0\u{4}\u{2}encryption_type\0\u{1}attributes\0\u{3}text_header\0\u{3}byte_header\0")
  ...
  public static func ==(lhs: Livekit_DataStream.Header, rhs: Livekit_DataStream.Header) -> Bool {
...
extension Livekit_DataStream.Chunk: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Livekit_DataStream.protoMessageName + ".Chunk"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}stream_id\0\u{3}chunk_index\0\u{1}content\0\u{1}version\0\u{1}iv\0")
  ...
  public static func ==(lhs: Livekit_DataStream.Chunk, rhs: Livekit_DataStream.Chunk) -> Bool {
    if lhs.streamID != rhs.streamID {return false}
...
extension Livekit_DataStream.Trailer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Livekit_DataStream.protoMessageName + ".Trailer"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}stream_id\0\u{1}reason\0\u{1}attributes\0")
  ...
  public static func ==(lhs: Livekit_DataStream.Trailer, rhs: Livekit_DataStream.Trailer) -> Bool {
    if lhs.streamID != rhs.streamID {return false}
...
extension Livekit_FilterParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FilterParams"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}include_events\0\u{3}exclude_events\0")
  ...
  public static func ==(lhs: Livekit_FilterParams, rhs: Livekit_FilterParams) -> Bool {
...
extension Livekit_WebhookConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}url\0\u{3}signing_key\0\u{3}filter_params\0")
  ...
  public static func ==(lhs: Livekit_WebhookConfig, rhs: Livekit_WebhookConfig) -> Bool {
...
extension Livekit_SubscribedAudioCodec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SubscribedAudioCodec"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}codec\0\u{1}enabled\0")
  ...
  public static func ==(lhs: Livekit_SubscribedAudioCodec, rhs: Livekit_SubscribedAudioCodec) -> Bool {
