...
public enum Livekit_MetricLabel: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Livekit_MetricLabel] = [
    .agentsLlmTtft,
    .agentsSttTtft,
    .agentsTtsTtfb,
...
public struct Livekit_MetricsBatch: Sendable {
  ...
  public var normalizedTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasNormalizedTimestamp: Bool {self._normalizedTimestamp != nil}
  /// Clears the value of `normalizedTimestamp`. Subsequent reads from it will return its default value.
  public mutating func clearNormalizedTimestamp() {self._normalizedTimestamp = nil}
  ...
  public var timeSeries: [Livekit_TimeSeriesMetric] = []

  public var events: [Livekit_EventMetric] = []
...
public struct Livekit_TimeSeriesMetric: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var label: UInt32 = 0

  /// index into `str_data`
  public var participantIdentity: UInt32 = 0

  /// index into `str_data`
  public var trackSid: UInt32 = 0

  public var samples: [Livekit_MetricSample] = []

  /// index into 'str_data'
  public var rid: UInt32 = 0
...
public struct Livekit_MetricSample: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Livekit_EventMetric: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var startTimestampMs: Int64 = 0
  ...
  public var hasEndTimestampMs: Bool {self._endTimestampMs != nil}
  /// Clears the value of `endTimestampMs`. Subsequent reads from it will return its default value.
  public mutating func clearEndTimestampMs() {self._endTimestampMs = nil}

  public var normalizedStartTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasNormalizedStartTimestamp: Bool {self._normalizedStartTimestamp != nil}
  /// Clears the value of `normalizedStartTimestamp`. Subsequent reads from it will return its default value.
  public mutating func clearNormalizedStartTimestamp() {self._normalizedStartTimestamp = nil}

  public var normalizedEndTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasNormalizedEndTimestamp: Bool {self._normalizedEndTimestamp != nil}
  /// Clears the value of `normalizedEndTimestamp`. Subsequent reads from it will return its default value.
  public mutating func clearNormalizedEndTimestamp() {self._normalizedEndTimestamp = nil}
...
public struct Livekit_MetricsRecordingHeader: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var roomTags: Dictionary<String,String> = [:]
...
extension Livekit_MetricsBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MetricsBatch"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}timestamp_ms\0\u{3}normalized_timestamp\0\u{3}str_data\0\u{3}time_series\0\u{1}events\0")
  ...
  public static func ==(lhs: Livekit_MetricsBatch, rhs: Livekit_MetricsBatch) -> Bool {
...
extension Livekit_TimeSeriesMetric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TimeSeriesMetric"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}label\0\u{3}participant_identity\0\u{3}track_sid\0\u{1}samples\0\u{1}rid\0")
  ...
  public static func ==(lhs: Livekit_TimeSeriesMetric, rhs: Livekit_TimeSeriesMetric) -> Bool {
...
extension Livekit_MetricSample: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}timestamp_ms\0\u{3}normalized_timestamp\0\u{1}value\0")
  ...
  public static func ==(lhs: Livekit_MetricSample, rhs: Livekit_MetricSample) -> Bool {
    if lhs.timestampMs != rhs.timestampMs {return false}
    if lhs._normalizedTimestamp != rhs._normalizedTimestamp {return false}
...
extension Livekit_EventMetric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".EventMetric"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}label\0\u{3}participant_identity\0\u{3}track_sid\0\u{3}start_timestamp_ms\0\u{3}end_timestamp_ms\0\u{3}normalized_start_timestamp\0\u{3}normalized_end_timestamp\0\u{1}metadata\0\u{1}rid\0")
  ...
  public static func ==(lhs: Livekit_EventMetric, rhs: Livekit_EventMetric) -> Bool {
    if lhs.label != rhs.label {return false}
    if lhs.participantIdentity != rhs.participantIdentity {return false}
    if lhs.trackSid != rhs.trackSid {return false}
...
extension Livekit_MetricsRecordingHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MetricsRecordingHeader"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}room_id\0\u{2}\u{2}duration\0\u{3}start_time\0\u{3}room_tags\0")
  ...
  public static func ==(lhs: Livekit_MetricsRecordingHeader, rhs: Livekit_MetricsRecordingHeader) -> Bool {
