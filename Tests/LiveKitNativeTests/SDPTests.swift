...
final class SDPTests: XCTestCase {
    ...
    func testPublisherOfferIncludesSendOnlyTracksAndNegotiationLines() throws {
        ...
        XCTAssertEqual(parsedOffer.bundleMIDs, ["0", "1", "data"])
        ...
        XCTAssertEqual(parsedOffer.mediaSections[2].mediaLine, "application 9 UDP/DTLS/SCTP webrtc-datachannel")
        ...
        XCTAssertTrue(parsedOffer.mediaSections[2].attributes.contains("mid:data"))
        XCTAssertTrue(parsedOffer.mediaSections[2].attributes.contains("setup:actpass"))
        XCTAssertTrue(parsedOffer.mediaSections[2].attributes.contains("sctp-port:5000"))
